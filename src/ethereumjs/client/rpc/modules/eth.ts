...
import { Account, Address, BN, bufferToHex, toBuffer, stripHexPrefix, setLengthLeft } from "ethereumjs-util";
...
export class Eth {
  ...
  constructor(client: EthereumClient) {
    ...
    this.call = middleware(this.call.bind(this), 2, [[validators.transaction(["to"])], [validators.blockOption]]);
    ...
    this.getBalance = middleware(this.getBalance.bind(this), 2, [[validators.address], [validators.blockOption]]);

    this.getBlockByNumber = middleware(this.getBlockByNumber.bind(this), 2, [[validators.hex], [validators.bool]]);
    ...
    this.getCode = middleware(this.getCode.bind(this), 2, [[validators.address], [validators.blockOption]]);
